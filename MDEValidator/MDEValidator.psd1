@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'v1.2.0 — PUAProtection Check

New check:
- Test-MDEPUAProtection — validates AV-engine PUA (Potentially Unwanted Application) protection state
  - Pass: PUA protection enabled (Block mode)
  - Warning: PUA protection in Audit mode only
  - Fail: PUA protection disabled
