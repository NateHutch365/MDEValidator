@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'v1.4.0 — HTML Report Modernisation

Redesigned HTML validation report:
- Gradient header, summary cards, and section-grouped tables
- 4-column layout: Test, Result, Expected, Details
- Unicode status icons and print-optimised CSS
- All report changes confined to Get-MDEValidationReport.ps1

Previous release (v1.2.0):
- Test-MDEPUAProtection — validates AV-engine PUA protection state (Pass/Warning/Fail)

Total: 384 Pester tests (0 failures), zero PSScriptAnalyzer violations'
        }
    }
}
