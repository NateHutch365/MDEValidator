...
function Get-MDEManagedDefenderProductType {
    ...
    try {
        ...
        elseif ($managedDefenderProductType -eq 7) {
            # Mixed management - need to check EnrollmentStatus
            ...
            elseif ($enrollmentStatus -eq 3) {
                ...
                # Unknown configuration with ManagedDefenderProductType = 7
                $managementType = 'Mixed Management (unknown configuration)'
                $isManagedForExclusions = $false
            }
        }
        else {
            # Not managed by Intune or Configuration Manager
            # Fall back to EnrollmentStatus interpretation
