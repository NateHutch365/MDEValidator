...
BeforeAll {
    # Import the module
    $modulePath = Join-Path (Join-Path (Join-Path $PSScriptRoot '..') 'MDEValidator') 'MDEValidator.psm1'
...
Describe 'MDEValidator Module' {
    Context 'Module Import' {
        It 'Should import the module without errors' {
            { Import-Module (Join-Path (Join-Path (Join-Path $PSScriptRoot '..') 'MDEValidator') 'MDEValidator.psm1') -Force } | Should -Not -Throw
        }
